...
function Navbar({ companyId, companyName, onLogout }) {
  ...
  return (
    <aside className="w-60 bg-bg-secondary border-r border-border-subtle flex flex-col h-screen sticky top-0">
      {/* Logo */}
      <div className="p-4 mb-2">
        <div className="flex items-center gap-3 px-3 py-2">
          <div className="w-9 h-9 bg-gradient-to-br from-accent to-accent-hover rounded-lg flex items-center justify-center shadow-sm">
