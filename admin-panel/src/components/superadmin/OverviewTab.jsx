          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              {systemHealth?.ollama_model && (
                <div className="mt-3 inline-flex items-center gap-2 px-3 py-1.5 bg-bg-tertiary border border-border-subtle rounded-lg">
                  ...
                  <span className="text-xs font-mono font-medium text-text-primary">{systemHealth.ollama_model}</span>
                </div>
              )}
            </div>
          </div>
